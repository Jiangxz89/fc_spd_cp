...
<body>
	<form:form id="inputForm" modelAttribute="pdProduct" enctype="multipart/form-data" method="post">
		...
		<div class="right-main-box">
			...
			<div class="addProductBox">
				...
				<input type="text" name="number" required id="number" value="${pdProduct.number }" />
				<c:if test="${flag == 'see' }">
					<a href="###" class="hcy-btn hcy-btn-primary" id="codePrint">条码打印</a>
				</c:if>
				<br />
				<label for=""><span class="mustIcon">*</span>产品名称</label>
				<input type="text" name="name" id="proInp" onKeyUp="query()" value="${pdProduct.name }" required="required"/>
				<label for="">首拼码</label>
				<input type="text" id="proSpm" name="spm" value="${pdProduct.spm }"/><br />
				<label for=""><span class="mustIcon"  >*</span>规格</label>
				<input type="text" name="spec" value="${pdProduct.spec }"  required/>
				<label for=""><span class="mustIcon">*</span>型号</label>
				<input type="text" name="version" value="${pdProduct.version }" required/><br />
				<label for=""><span class="mustIcon">*</span>单位</label>
				<input type="text" name="unit" value="${pdProduct.unit }" required/>
				<div class="addSelect">
					<label for=""><span class="mustIcon">*</span>产品组别</label>
					<input type="hidden" name="groupId" value="${pdProduct.groupId }"/>
					<input type="text" readonly autocomplete="off" name="groupName" value="${spd:getGroupName(pdProduct.groupId) }"  required placeholder="--请选择--" class="proClassify"/>
				...
				<select style="width:260px;height:30px;" name="type" onchange="typeChange()" id="prodType" value="${pdProduct.type }"  required>
				...
				<div class="addSelect">
					...
					<input type="text" autocomplete="off" readonly name="categoryName" value="${spd:getCategoryName(pdProduct.categoryId) }"  required class="proClassify" placeholder="--请选择--"/>
					<ul id="addCategory" class="addOption">
						<li><i class="fa fa-plus"></i>新增产品分类</li>
					</ul>
				</div><br />
				<label for=""><span class="mustIcon">*</span>生产厂家</label>
				<select style="width:260px;height:30px;" value="${pdProduct.id }" id="venderId" name="venderId" required>
					<option value="">--请选择--</option>
					<c:forEach var="pdVender" items="${pdVenderList}">  
                        <option value="${pdVender.id}" <c:if test="${pdVender.id eq pdProduct.venderId}">selected</c:if>>${pdVender.name}</option>  
                    </c:forEach> 
				</select>
				<br />
				<label for=""><span class="mustIcon">*</span>产品进价</label>
				<input type="text" name="purPrice" value="${pdProduct.purPrice }" required/>
				<label for=""><span class="mustIcon">*</span>产品出价</label>
				<input type="text" name="sellingPrice" value="${pdProduct.sellingPrice }" required/></br>
				<label for=""><span class="mustIcon">*</span>注册证</label>
				<input type="text" style="width:632px;" name="registration" value="${pdProduct.registration }" required/><label class="autoLab">多个注册证以“；”分开</label><br />
				<label for="" style="vertical-align:top;">备注</label>
				<div class="areaTxtBox">
					<textarea class="spdRemarks" name="description" style='margin: 0;display: block;border: none;box-shadow: none' maxlength="200" >${pdProduct.description }</textarea>
				...
				<div class="cardBoxWrap" style="padding-left:105px;">
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	...
			            	<input type="text" name="imgAuthNum" value="${pdProduct.imgAuthNum }"/><br />
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgRegister1Num" value="${pdProduct.imgRegister1Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgRegister1Date" value="<fmt:formatDate value="${pdProduct.imgRegister1Date }" pattern="yyyy-MM-dd" />"/>
			            </div>
			            <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgRegister1Site == '' || pdProduct.imgRegister1Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgRegister1Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgRegister1Site == '' || pdProduct.imgRegister1Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgRegister1Site" value="${pdProduct.imgRegister1Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgRegister2Num" value="${pdProduct.imgRegister2Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgRegister2Date" value="<fmt:formatDate value="${pdProduct.imgRegister2Date }" pattern="yyyy-MM-dd" />"/>
			            </div>
			            <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgRegister2Site == '' || pdProduct.imgRegister2Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgRegister2Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgRegister2Site == '' || pdProduct.imgRegister2Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgRegister2Site" value="${pdProduct.imgRegister2Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgRegister3Num" value="${pdProduct.imgRegister3Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgRegister3Date" value="<fmt:formatDate value="${pdProduct.imgRegister3Date }" pattern="yyyy-MM-dd" />"/>
			            </div>
			            <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgRegister3Site == '' || pdProduct.imgRegister3Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgRegister3Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgRegister3Site == '' || pdProduct.imgRegister3Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgRegister3Site" value="${pdProduct.imgRegister3Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgLicense1Num" value="${pdProduct.imgLicense1Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgLicense1Date" value="<fmt:formatDate value="${pdProduct.imgLicense1Date }" pattern="yyyy-MM-dd" />"/>
			            </div>
			           <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgLicense1Site == '' || pdProduct.imgLicense1Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgLicense1Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgLicense1Site == '' || pdProduct.imgLicense1Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgLicense1Site" value="${pdProduct.imgLicense1Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgLicense2Num" value="${pdProduct.imgLicense2Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgLicense2Date" value="<fmt:formatDate value="${pdProduct.imgLicense2Date }" pattern="yyyy-MM-dd" />"/>
			            </div>
			           <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgLicense2Site == '' || pdProduct.imgLicense2Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgLicense2Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgLicense2Site == '' || pdProduct.imgLicense2Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgLicense2Site" value="${pdProduct.imgLicense2Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgLicense3Num" value="${pdProduct.imgLicense3Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgLicense3Date" value="<fmt:formatDate value="${pdProduct.imgLicense3Date }" pattern="yyyy-MM-dd"/>"/>
			            </div>
			           <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""/> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgLicense3Site == '' || pdProduct.imgLicense3Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgLicense3Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgLicense3Site == '' || pdProduct.imgLicense3Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgLicense3Site" value="${pdProduct.imgLicense3Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          		...
	          		<div class="card-box">
			            ...
			            <div class="card-box-code">
			            	<label for="">证照号码</label>
			            	<input type="text" name="imgLicense4Num" value="${pdProduct.imgLicense4Num }"/><br />
			            	<label for="">有效期至</label>
			            	<input type="text" class="validTime" name="imgLicense4Date" value="<fmt:formatDate value="${pdProduct.imgLicense4Date }" pattern="yyyy-MM-dd"/>"/>
			            </div>
			            <div class="controls"> 
			            	<input type="text" class="required validate_hidden" value=""> 
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgLicense4Site == '' || pdProduct.imgLicense4Site == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgLicense4Site }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgLicense4Site == '' || pdProduct.imgLicense4Site == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgLicense4Site" value="${pdProduct.imgLicense4Site }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          			...
	          			<div class="controls"> 
				            ...
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgProductSite1 == '' || pdProduct.imgProductSite1 == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgProductSite1 }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgProductSite1 == '' || pdProduct.imgProductSite1 == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgProductSite1" value="${pdProduct.imgProductSite1 }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          			...
	          			<div class="controls"> 
				            ...
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgProductSite2 == '' || pdProduct.imgProductSite2 == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgProductSite2 }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgProductSite2 == '' || pdProduct.imgProductSite2 == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgProductSite2" value="${pdProduct.imgProductSite2 }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	          			...
	          			<div class="controls"> 
				            ...
				            <div class='pictureUploadDiv'>
								<div class='tR_upPic_icon'  style="width:auto;height: auto;background:none;border:1px solid #ccc;margin:10px 0 0 10px;">
									...
									<div class="smallImg" style='display:block;width:256px;height:160px;' >
										<img <c:if test="${pdProduct.imgProductSite3 == '' || pdProduct.imgProductSite3 == null}">style="display:none;"</c:if> src="${ctxImg }${pdProduct.imgProductSite3 }" class="card-box_img"/>
										<div <c:if test="${pdProduct.imgProductSite3 == '' || pdProduct.imgProductSite3 == null || flag == 'see'}">style="display:none;"</c:if> class="smallImg_cloBtn" data-hiddenid='imgUrl'></div>
									</div>
									<input type="hidden" name="imgProductSite3" value="${pdProduct.imgProductSite3 }" />
									<span class="addIcon">+</span>
								</div>
							</div>
						</div>
	...
	<div id="codePrintBox" class="codePrintBox" style="display:none;">
		<div class="codeListBox" style="margin-top:20px;"><h5 style="display:inline-block;">厂商：</h5><span class="venderNameSpan">美敦力（上海）管理有限公司</span></div>
		<div class="codeListBox"><h5 style="display:inline-block;">产品名称：</h5 style="display:inline-block;"><span class="proNameSpan">冠状动脉球囊扩张导管</span></div>
		<div class="specLine codeListBox"><h5 style="display:inline-block;">规格：</h5><span class="specSpan">2.00mm*15mm</span></div>
		<div class="versionLine codeListBox" style="margin-bottom:40px;"><h5 style="display:inline-block;">型号：</h5><span class="versionSpan">LA20015</span></div>
		<div><img src="${ctxImg }images/spd/barcode/${pdProduct.number}.jpg" id="barcodeImg" /></div>
	</div>
	...
	<script type="text/javascript">
			...
			function sub(){
				$("#inputForm").attr("action","${ctx}/hys/pdProduct/update?flag="+$("[name=flag]").val());
				return true;
			}
