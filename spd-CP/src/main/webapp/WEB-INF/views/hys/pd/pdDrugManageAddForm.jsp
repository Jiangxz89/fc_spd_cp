	...
	<form:form id="inputForm" modelAttribute="pdProduct" enctype="multipart/form-data" method="post">
		...
		<div class="right-main-box">
			...
			<div class="addProductBox">
				...
				<label for="">医保统一编码</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for="">是否基药</label>
				<select>
					<option value="">是</option>
					<option value="">否</option>
				</select>
				<label for="">是否抗生素</label>
				<select>
					<option value="">是</option>
					<option value="">否</option>
				</select><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->中药使用类别代码</label>
				<input type="text" name="" required id="" value="" />
				<label for="">药物类型</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->药品名称</label>
				<input type="text" name="" required id="" value="" />
				<label for="">药物剂型代码</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->药品规格</label>
				<input type="text" name="" required id="" value="" />
				<label for="">包装单位数量关系</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->大包装单位</label>
				<input type="text" name="" required id="" value="" />
				<label for="">小包装单位</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->进价单价</label>
				<input type="text" name="" required id="" value="" />
				<label for="">零售单价</label>
				<input type="text" name="" required id="" value="" /><br />
				<label for=""><!-- <span class="mustIcon">*</span> -->生产企业</label>
				<input type="text" name="" required id="" value="" />
				<label for="">药品产地</label>
				<input type="text" name="" required id="" value="" /><br />
