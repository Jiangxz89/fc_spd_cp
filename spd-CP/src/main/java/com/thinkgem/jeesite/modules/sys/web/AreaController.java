...
//		}
	...
	public void ajaxGet(HttpServletRequest request, HttpServletResponse response){
		...
		List<Area> findList = areaService.ajaxGet(area);
	 ...
	 * Ajax
	 * */
	@RequestMapping(value = "ajaxGetForExist")
	public void ajaxGetForExist(HttpServletRequest request, HttpServletResponse response){
		
		
		List<Area> findList = areaService.findList(new Area());
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "citiesByProvinceCode")
	public List<City> citiesByProvinceCode(String id,HttpServletRequest request, HttpServletResponse response){
		Area area = new Area();
		area.setId(id);
		area.setType(MinaGlobalConstants.AREA_3);
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "countiesByCityCode")
	public List<City> countiesByCityCode(String id,HttpServletRequest request, HttpServletResponse response){
		Area area = new Area();
		area.setId(id);
		area.setType(MinaGlobalConstants.AREA_4);
		List<City> findList = areaService.findListByParentCode(area);
		return findList;
	}
}
