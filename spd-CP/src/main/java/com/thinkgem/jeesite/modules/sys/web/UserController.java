...
public class UserController extends BaseController {
	...
	public String delete(User user, RedirectAttributes redirectAttributes) {
		...
		if (UserUtils.getUser().getId().equals(user.getId())){
			...
			//如果是供应商角色则删除供应商
			PdSupplier pdSupplier = pdSupplierService.findByAccount(user);
			if(pdSupplier!=null){
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "checkSupplierLoginName")
	public String checkSupplierLoginName(HttpServletRequest request) {
		String loginName = request.getParameter("loginName");
		String oldLoginName = request.getParameter("oldLoginName");
		try{
			if (loginName !=null && loginName.equals(oldLoginName)) {
				return "true";
			} else if(systemService.getUserByLoginName(loginName) == null){
				return "true";
			}
		}catch(Exception e){
			e.printStackTrace();
